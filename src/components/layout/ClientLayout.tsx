...
import { Bell, Link2, ChevronLeft, ChevronRight, Eye, FileText, IndianRupee, LayoutDashboard, LogOut, Menu, TrendingUp, User, X } from "lucide-react";
...
const navItems = [
  ...
  { to: "/client/blueprints", label: "Links", icon: Link2 },
