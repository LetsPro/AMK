...
Updates banners, services, and testimonials with refined messaging and imagery.
All updates are safe: uses UPDATE with specific WHERE clauses and INSERT ... WHERE NOT EXISTS
guards, so no data is lost or duplicated.
*/
...
set title = 'Beyond Buildings. We Design Experiences.',
    ...
    cta_label = 'Start a Project', cta_url = '/contact', is_active = true, updated_at = now()
...
set title = 'Where Architecture Meets Innovation',
    ...
    cta_label = 'View Projects', cta_url = '/projects', is_active = true, updated_at = now()
...
set title = 'Designing Tomorrow. Building Beyond.',
    ...
    cta_label = 'Get Started', cta_url = '/customer-register', is_active = true, updated_at = now()
...
update services set name = 'Architecture & Master Planning', description = 'Luxury residences, villas, apartments, commercial buildings, healthcare, hospitality, institutional, mixed-use, urban design, and master planning solutions.', image_url = 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=1200&q=80', price_from = 75000, status = 'published', updated_at = now() where slug = 'architectural-design';
update services set name = 'BIM & Digital Engineering', description = 'BIM modelling, documentation, clash detection, construction documentation, quantity extraction, shop drawings, and digital project coordination.', image_url = 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1200&q=80', price_from = 55000, status = 'published', updated_at = now() where slug = 'approval-drawings';
update services set name = 'Engineering Solutions', description = 'Structural coordination, electrical design, plumbing design, storm water management, infrastructure planning, and utility coordination.', image_url = 'https://images.unsplash.com/photo-1494526585095-c41746248156?auto=format&fit=crop&w=1200&q=80', price_from = 55000, status = 'published', updated_at = now() where slug = 'structural-engineering';
...
set name = excluded.name, description = excluded.description,
    image_url = excluded.image_url, price_from = excluded.price_from,
    status = excluded.status, updated_at = now();

update testimonials set name = 'Homeowner, Mysuru', company = 'Residential Client', quote = 'From the initial concept to the final design, the AMK team demonstrated exceptional creativity, professionalism, and technical expertise.', rating = 5, is_published = true, updated_at = now() where name = 'Raghavendra Rao' and company = 'Chamundi Hill Residence';
update testimonials set name = 'Commercial Property Owner', company = 'Commercial Client', quote = 'AMK Architects & Engineers delivered a well-planned commercial project that balanced design, efficiency, and investment value.', rating = 5, is_published = true, updated_at = now() where name = 'Nandini Prakash' and company = 'Vijayanagar Courtyard Home';
update testimonials set name = 'Real Estate Developer', company = 'Development Client', quote = 'Their expertise in planning, engineering coordination, and project execution gave us complete confidence throughout the project.', rating = 5, is_published = true, updated_at = now() where name = 'Mohammed Irfan' and company = 'Hebbal Workspace Studio';
